    ...
    const handleLogin = async (e) => {
        ...
        try {
            ...
            if (res.data.success) {
                ...
                // DO NOT save to localStorage yet. Pass data to OTP page.
                setTimeout(() => {
                    navigate('/verify-otp', {
                        state: {
        ...
        <div className="min-h-screen bg-white dark:bg-[#0b0c0d]">
            ...
            <div className="max-w-[1440px] mx-auto px-6 py-20">
                {localStorage.getItem("token") ? (
                    <div className="bg-[#f8f9fa] dark:bg-[#151618] p-12 rounded-[10px] text-center max-w-[600px] mx-auto border border-gray-100 dark:border-gray-800 shadow-xl">
                        <div className="w-24 h-24 bg-[#f17840]/10 text-[#f17840] rounded-full flex items-center justify-center mx-auto mb-6">
                        ...
                        <div className="grid grid-cols-1 gap-4">
                            <button
                                onClick={() => navigate("/")}
                                className="w-full bg-[#f17840] text-white py-4 rounded-[5px] font-black text-lg hover:bg-[#e06b35] transition-all shadow-md"
                            >
                                Continue Shopping
                            </button>
                            <button
                    ...
                    <>
                        {action === "register" && !message && !error && (
                            <div className="mb-6 p-4 bg-[#f17840]/10 border border-[#f17840]/20 text-[#f17840] rounded text-center font-black animate-pulse uppercase tracking-wider">
