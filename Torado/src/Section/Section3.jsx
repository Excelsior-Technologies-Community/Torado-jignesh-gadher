        ...
        <div className="group relative bg-white dark:bg-[#151618] rounded-[10px] p-5 border border-gray-100 dark:border-none hover:border-[#f17840]/30 transition-all duration-500 flex flex-col h-full">
            ...
            <div className="relative bg-[#f8f9fa] dark:bg-white rounded-[10px] p-8 mb-6 overflow-hidden flex items-center justify-center min-h-[250px] transition-colors duration-300">
                ...
                <div className="absolute top-4 right-[-60px] group-hover:right-4 transition-all duration-500 flex flex-col gap-2 z-20">
                    ...
                    <button
                        ...
                        className={`w-10 h-10 shadow-sm rounded-full flex items-center justify-center transition-all duration-300 ${isCompared ? 'bg-[#f17840] text-white' : 'bg-white dark:bg-[#1a1c1e] text-[#253d4e] dark:text-white hover:bg-[#f17840] hover:text-white'}`}
                    >
                        <GitCompare size={18} />
                    </button>
                    <button
                        onClick={() => onQuickView(product)}
                        className="w-10 h-10 bg-white dark:bg-[#1a1c1e] shadow-sm rounded-full flex items-center justify-center text-[#253d4e] dark:text-white hover:bg-[#f17840] hover:text-white transition-all duration-300"
                    >
                        <Maximize size={18} />
                    </button>
                </div>
            ...
            <div className="flex flex-col flex-grow">
                ...
                <div className="flex items-center gap-2 mb-6">
                    ...
                    <span className="text-gray-400 dark:text-gray-500 text-sm font-medium">({product.reviews_count || '1k+'}) Ratings</span>
                </div>
...
const Section3 = () => {
    ...
    const fetchProducts = async () => {
        try {
            ...
            console.error("Failed to fetch products for section 3", err);
        } finally {
            setLoading(false);
        }
    };
