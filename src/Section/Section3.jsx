...
const ProductCard = ({ product }) => (
    <div className="group relative bg-white rounded-[10px] p-5 border border-gray-100 hover:border-[#f17840]/30 hover:shadow-xl transition-all duration-500 flex flex-col h-full">
        ...
        <div className="relative bg-[#f8f9fa] rounded-[10px] p-8 mb-6 overflow-hidden flex items-center justify-center min-h-[250px]">
            <img
                src={product.image}
                alt={product.name}
            ...
            <div className="absolute top-4 right-[-60px] group-hover:right-4 transition-all duration-500 flex flex-col gap-2 z-20">
                <button className="w-10 h-10 bg-white shadow-sm rounded-full flex items-center justify-center text-[#253d4e] hover:bg-[#f17840] hover:text-white transition-all duration-300">
                    <Heart size={18} />
                </button>
                <button className="w-10 h-10 bg-white shadow-sm rounded-full flex items-center justify-center text-[#253d4e] hover:bg-[#f17840] hover:text-white transition-all duration-300">
                    <GitCompare size={18} />
        ...
        <div className="flex flex-col flex-grow">
            <div className="flex items-center gap-3 mb-3">
                ...
                <span className="text-gray-400 line-through text-base font-medium">${product.oldPrice}</span>
            </div>

            <h3 className="text-[#253d4e] font-extrabold text-[17px] leading-tight mb-4 line-clamp-2">
                {product.name}
            </h3>
            ...
            <div className="flex items-center gap-2 mb-6">
                ...
                <span className="text-gray-400 text-sm font-medium">({product.reviews} Ratings)</span>
            </div>

            <div className="relative group/btn overflow-hidden w-full h-[50px]">
                <button className="w-full h-full bg-white text-[#f17840] rounded-[5px] font-bold text-[15px] transition-all duration-300 border border-gray-100 shadow-sm flex items-center justify-center gap-2">
                    Add To Cart
                </button>
...
const Section3 = () => {
    ...
    return (
        <section className="w-full bg-white py-16 px-4 md:px-10 lg:px-16 overflow-hidden">
            <div className="max-w-[1400px] mx-auto">
                {/* Header with navigation */}
                <div className="flex items-center justify-between mb-12">
                    <h2 className="text-[32px] font-black text-[#253d4e]">New Arrivals</h2>
                    <div className="flex gap-3">
                        <button
                            onClick={() => scroll("left")}
                            className="w-10 h-10 rounded-full border border-gray-200 flex items-center justify-center hover:bg-[#f17840] hover:text-white transition"
                        >
                            <ChevronLeft size={20} />
                        </button>
                        <button
                ...
                <div className="mt-20 grid grid-cols-1 md:grid-cols-2 gap-8">
                    {/* Card 1 */}
                    <div className="relative overflow-hidden bg-[#f3f4f9] rounded-[15px] p-8 md:p-12 flex flex-col md:flex-row items-center justify-between group min-h-[300px]">
                        <div className="z-10 text-center md:text-left relative">
                            ...
                            <h3 className="text-[#253d4e] font-black text-2xl md:text-2xl lg:text-3xl mb-4 leading-tight max-w-[200px]">
                                Wall Polishing Square Box
                            </h3>
                            <p className="text-gray-500 text-sm md:text-base mb-8">In accessories At Best Price</p>
                            <button className="bg-white text-[#253d4e] font-extrabold py-3 px-8 rounded-[5px] hover:bg-[#f17840] hover:text-white transition-all duration-300 shadow-sm text-sm uppercase">
                                Shop Now
                            </button>
                        </div>
                    ...
                    {/* Card 2 */}
                    <div className="relative overflow-hidden bg-[#edf4f3] rounded-[15px] p-8 md:p-12 flex flex-col md:flex-row items-center justify-between group min-h-[300px]">
                        <div className="z-10 text-center md:text-left relative">
                            <span className="text-[#f17840] font-bold text-xs md:text-sm tracking-[2px] uppercase mb-4 block">Flash Deals</span>
                            <h3 className="text-[#253d4e] font-black text-2xl md:text-2xl lg:text-3xl mb-4 leading-tight max-w-[250px]">
                                Adjustable Hand Rubber Tools
                            </h3>
                            <p className="text-gray-500 text-sm md:text-base mb-8">In accessories At Best Price</p>
                            <button className="bg-[#f17840] text-white font-extrabold py-3 px-8 rounded-[5px] hover:bg-[#253d4e] transition-all duration-300 shadow-sm text-sm uppercase">
                                Shop Now
                            </button>
                        </div>
                        <div className="relative mt-8 md:mt-0 flex items-center justify-center">
