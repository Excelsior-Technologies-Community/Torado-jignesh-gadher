...
import { Calendar, CheckCircle2, Facebook, Instagram, MessageSquare, Quote, Search, Twitter, User } from "lucide-react";
    ...
    const popularPosts = [
        {
            ...
            date: "28 June, 2025",
            image: "https://torado.envytheme.com/machine-tools-parts-shop/default/assets/img/blog/post-thumb-1.webp"
        },
        {
            id: 2,
            title: "Why We Used Best Hand Tools for used?",
            date: "15 June, 2025",
            image: "https://torado.envytheme.com/machine-tools-parts-shop/default/assets/img/blog/post-thumb-2.webp"
        },
        {
            id: 3,
            title: "Best Thoughtful Gift Ideas For Your Girlfriend",
            date: "10 June, 2025",
            image: "https://torado.envytheme.com/machine-tools-parts-shop/default/assets/img/blog/post-thumb-3.webp"
        }
    ];
            ...
            <div className="max-w-[1440px] mx-auto px-6 py-20">
                <div className="flex flex-col lg:flex-row gap-12">
                    ...
                    <aside className="w-full lg:w-[320px] shrink-0 space-y-10">
                        ...
                        {/* Search Widget */}
                        <div className="bg-white dark:bg-[#151618] p-8 rounded-xl border border-gray-100 dark:border-gray-800 shadow-sm transition-colors">
                            <form className="relative flex items-center">
                                <input
                                    type="text"
                                    placeholder="Search"
                                    className="w-full bg-[#f8f9fa] dark:bg-[#1a1c1e] border border-gray-100 dark:border-gray-800 rounded-lg px-6 py-4 outline-none focus:border-[#f17840] transition-colors dark:text-white font-medium"
                                />
                                <button type="submit" className="absolute right-0 top-0 h-full aspect-square bg-[#f17840] hover:bg-[#e06b35] text-white rounded-r-lg flex items-center justify-center transition-colors">
                                    <Search size={22} />
                                </button>
                            </form>
                        </div>
                        ...
                        <div className="bg-white dark:bg-[#151618] p-8 rounded-xl border border-gray-100 dark:border-gray-800 shadow-sm transition-colors">
                            <h3 className="text-[20px] font-black text-[#253d4e] dark:text-white mb-6 pb-2 border-b-2 border-gray-50 dark:border-gray-800 relative">
                                Popular Posts
                                <span className="absolute bottom-[-2px] left-0 w-10 h-[2px] bg-[#f17840]"></span>
                            </h3>
                            <div className="space-y-6">
                                {popularPosts.map((post) => (
                                    <div key={post.id} className="flex gap-4 group cursor-pointer">
                                        ...
                                        <div>
                                            <p className="text-[12px] font-bold text-gray-500 mb-1">{post.date}</p>
                                            <h4 className="text-[14px] font-black text-[#253d4e] dark:text-gray-200 line-clamp-2 leading-tight group-hover:text-[#f17840] transition-colors">
                                                {post.title}
                                            </h4>
                                        </div>
                                    </div>
                            ...
                            <ul className="space-y-4">
                                {categories.map((category, index) => (
                                    <li key={index} className="flex items-center gap-3 group cursor-pointer">
                                        ...
                                        <span className="text-[15px] font-bold text-[#7e7e7e] dark:text-gray-400 group-hover:text-[#f17840] group-hover:translate-x-1 transition-all">
                                            {category}
                                        </span>
                                    </li>
                                ))}
                        ...
                        <div className="bg-white dark:bg-[#151618] p-8 rounded-xl border border-gray-100 dark:border-gray-800 shadow-sm transition-colors">
                            ...
                            <div className="flex flex-wrap gap-2">
                                {tags.map((tag, index) => (
                                    <button
                                        key={index}
                                        className="px-4 py-2 text-[13px] font-bold text-[#7e7e7e] dark:text-gray-400 bg-gray-50 dark:bg-[#1a1c1e] border border-gray-100 dark:border-gray-800 rounded-md hover:bg-[#f17840] hover:text-white hover:border-[#f17840] transition-all cursor-pointer"
                                    >
                                        {tag}
                                    </button>
                                ))}
