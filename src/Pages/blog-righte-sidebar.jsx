            ...
            <div className="max-w-[1440px] mx-auto px-6 py-20">
                <div className="flex flex-col lg:flex-row gap-12">
                    ...
                    <aside className="w-full lg:w-[32%] space-y-12">
                        {/* Search Widget */}
                        <div className="bg-[#f8f9fa] dark:bg-[#151618] p-8 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-sm">
                            ...
                            <ul className="space-y-4">
                                {categories.map((cat, idx) => (
                                    <li key={idx} className="flex items-center gap-3 group cursor-pointer border-b border-gray-100 dark:border-gray-800 pb-3 last:border-0 last:pb-0">
                                        ...
                                        <span className="text-[15px] font-bold text-gray-600 dark:text-gray-400 group-hover:text-[#f17840] transition-colors font-black">
                                            {cat}
                                        </span>
                                    </li>
                                ))}
                        ...
                        <div className="bg-[#f8f9fa] dark:bg-[#151618] p-8 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-sm">
                            ...
                            <div className="flex flex-wrap gap-3">
                                {tags.map((tag, idx) => (
                                    <span key={idx} className="px-5 py-2.5 bg-white dark:bg-[#0b0c0d] border border-gray-100 dark:border-gray-800 rounded-md text-[13px] font-black text-gray-500 dark:text-gray-400 hover:bg-[#f17840] hover:text-white hover:border-[#f17840] cursor-pointer transition-all uppercase">
                                        {tag}
                                    </span>
                                ))}
                            </div>
